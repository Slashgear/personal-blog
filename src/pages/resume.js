...
const Resume = () => (
  <Layout as={ResumeWrapper}>
    ...
    <h2>Profile</h2>
    <p>
      Professional Frontend developer passionate about his job. Very involved in
      the subjects I work on either for myself or for the companies I
      collaborate with. I have deep expertise in Web, React and frontend
      development but I am always ready to challenge myself and learn new
      things.
    </p>
    ...
    <p>
      ...
      video-on-demand streaming platform that has over 16 million active users,
      into a white label platform distributed in multiple countries for several
      customers. Thanks to a solid E2E and unit test stack, I contributed to the
      development of many user features that are now visible on sites like{' '}
      <a href="https://6play.fr">6play</a>, <a href="https://salto.fr">Salto</a>
    ...
    <ul>
      ...
      <li>
        Setting up of <i>Bedrock Academy</i> for simpler and faster way the new
    ...
    <ul>
      <li>
        "Introduction to frontend development", two days workshop on Javascript
        and VueJS
      </li>
      <li>
        "Software quality and design pattern", 40 hours of course about testing,
        design patterns
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        Participate in the animation of the Zenika frontend developers community
    ...
    <p>
      ...
      <a href="https://www.univ-lyon1.fr/">Claude Bernard University</a>, that I
      have been invited to give various courses to Master 1 or 2.
    </p>
  </Layout>
)
